    ...
    for i in range(1, len(df)):
        ...
        if state == "SEARCH_HIGH":
            ...
            if candle_high >= entry:
                # The research confirmation is evaluated on the ORIGINAL
                # 0.786 touch candle after it closes. If this is the latest
                # completed daily candle, evaluate the Strategy 05 rule now.
                if i == last_idx:
                ...
                # Continue base state for historical structure detection.
